# Hi, I'm Abinash Mishra 👋

Mechanical Engineering student at **NIT Calicut** (2023–2027) specialising in CFD, FEA and simulation-driven design. I work on aerospace systems, structural analysis and fluid dynamics — from full-airframe aerodynamic optimisation to rotating machinery simulations.
...
| **FEA** | ANSYS Static Structural, Abaqus, LS-DYNA, ADAMS |
| **CAD** | SolidWorks, Fusion 360, AutoCAD |
| **Data & Scripting** | Python (NumPy, Matplotlib), MATLAB, Excel |

**Simulation expertise:** External/internal aerodynamics · Sliding mesh (rotating machinery) · VOF multiphase · FSI · Fatigue & modal analysis · Transient thermal
...
**Technical Lead & Treasurer — Club Aerounwired, NIT Calicut**
CFD/FEA for national competition builds · Organised workshops for 300+ participants
